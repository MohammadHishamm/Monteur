...
// --- FORM-SIDE BACKGROUND (clean, static emerald wash) ---
export const BlobBackground = () => (
  <div className="pointer-events-none absolute inset-0">
    <div
      className="absolute inset-x-0 top-0 h-72"
      style={{
        background: `linear-gradient(to bottom, ${P.emerald}0f, transparent)`,
      }}
    />
  </div>
);

// --- GLASS INPUT + BUTTON STYLES (shared) ---
